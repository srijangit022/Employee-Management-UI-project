...
def login():
    ...
    elif usernameEntry.get()=='JOHN' and userPassword.get()=='1204':
...
headinglabel=CTkLabel(root,text='EMPLOYEE MANAGEMENT SYSTEM',bg_color='#A0E9FC',text_color='black',font=('Goudy Old Style',25,'bold'))
headinglabel.place(x=20,y=80)
